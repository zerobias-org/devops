...
export class AuditApiHttpImpl {
    ...
    async listAuditLogs(results, organizationId, filter, options) {
        ...
        let _path = '/organizations/{organizationId}/reports/auditLogs/ui';
        ...
        return this.client.get(_path, {
            ...
            results.baseUrl = new URL(`${this.client.getUri()}/organizations/{organizationId}/reports/auditLogs/ui`);
