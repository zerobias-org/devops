...
export class Entry {
    ...
    */
    ...
    constructor(id, name, opal, pincode, isPincodeEnabled, color, isMusterPoint, notes, externalUuid, isReaderless, isIntercomEntry, createdAt, updatedAt, zone, acu, wirelessLock, entryState, schedule, cameras) {
        this.id = id;
        this.name = name;
        this.opal = opal;
