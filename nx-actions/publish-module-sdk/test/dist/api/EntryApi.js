...
export class EntryApiHttpImpl {
    ...
    async get(organizationId, entryId) {
        const _queryParams = {};
        const _bodyParams = {};
        let _path = '/organizations/{organizationId}/entries/{entryId}';
        _path = _path.replace('{organizationId}', encodeURIComponent(String(organizationId)));
        _path = _path.replace('{entryId}', encodeURIComponent(String(entryId)));
    ...
    async list(results, organizationId) {
        ...
        let _path = '/organizations/{organizationId}/entries';
        _path = _path.replace('{organizationId}', encodeURIComponent(String(organizationId)));
        return this.client.get(_path, {
            ...
            results.baseUrl = new URL(`${this.client.getUri()}/organizations/{organizationId}/entries`);
    ...
    async listActivity(results, organizationId, entryId) {
        ...
        let _path = '/organizations/{organizationId}/entries/{entryId}/activity';
        _path = _path.replace('{organizationId}', encodeURIComponent(String(organizationId)));
        _path = _path.replace('{entryId}', encodeURIComponent(String(entryId)));
        return this.client.get(_path, {
            params: {
            ...
            results.pageToken = response.headers.pagetoken ?? response.headers.pageToken;
            results.headers = this.headers;
            results.baseUrl = new URL(`${this.client.getUri()}/organizations/{organizationId}/entries/{entryId}/activity`);
            results.httpMethod = HttpMethod.Get;
            results.body = _body;
    ...
    async listCameras(results, organizationId, entryId) {
        ...
        let _path = '/organizations/{organizationId}/entries/{entryId}/cameras';
        _path = _path.replace('{organizationId}', encodeURIComponent(String(organizationId)));
        _path = _path.replace('{entryId}', encodeURIComponent(String(entryId)));
        return this.client.get(_path, {
            params: {
            ...
            results.pageToken = response.headers.pagetoken ?? response.headers.pageToken;
            results.headers = this.headers;
            results.baseUrl = new URL(`${this.client.getUri()}/organizations/{organizationId}/entries/{entryId}/cameras`);
            results.httpMethod = HttpMethod.Get;
            results.body = _body;
    ...
    async listEntryStates(results, organizationId) {
        ...
        let _path = '/organizations/{organizationId}/entryStates';
        _path = _path.replace('{organizationId}', encodeURIComponent(String(organizationId)));
        return this.client.get(_path, {
            params: {
                ..._body,
            ...
            results.pageToken = response.headers.pagetoken ?? response.headers.pageToken;
            results.headers = this.headers;
            results.baseUrl = new URL(`${this.client.getUri()}/organizations/{organizationId}/entryStates`);
            results.httpMethod = HttpMethod.Get;
            results.body = _body;
    ...
    async listUserSchedules(results, organizationId, entryId) {
        ...
        let _path = '/organizations/{organizationId}/entries/{entryId}/userSchedules';
        _path = _path.replace('{organizationId}', encodeURIComponent(String(organizationId)));
        _path = _path.replace('{entryId}', encodeURIComponent(String(entryId)));
        return this.client.get(_path, {
            params: {
            ...
            results.pageToken = response.headers.pagetoken ?? response.headers.pageToken;
            results.headers = this.headers;
            results.baseUrl = new URL(`${this.client.getUri()}/organizations/{organizationId}/entries/{entryId}/userSchedules`);
            results.httpMethod = HttpMethod.Get;
            results.body = _body;
    ...
    async listUsers(results, organizationId, entryId) {
        ...
        let _path = '/organizations/{organizationId}/entries/{entryId}/users';
        _path = _path.replace('{organizationId}', encodeURIComponent(String(organizationId)));
        _path = _path.replace('{entryId}', encodeURIComponent(String(entryId)));
        return this.client.get(_path, {
            params: {
            ...
            results.pageToken = response.headers.pagetoken ?? response.headers.pageToken;
            results.headers = this.headers;
            results.baseUrl = new URL(`${this.client.getUri()}/organizations/{organizationId}/entries/{entryId}/users`);
            results.httpMethod = HttpMethod.Get;
            results.body = _body;
