...
export class ZoneApiHubImpl {
    ...
    async listZoneShares(results, organizationId, zoneId) {
        ...
        return this.client.put('/listZoneShares', {
            ..._body,
            ...
            results.baseUrl = new URL(`${this.client.getUri()}/listZoneShares`);
    ...
    async listZoneUsers(results, organizationId, zoneId) {
        ...
        return this.client.put('/listZoneZoneUsers', {
            ..._body,
            pageNumber: results.pageNumber,
            pageSize: results.pageSize,
        })
            ...
            results.pageToken = response.headers.pagetoken ?? response.headers.pageToken;
            results.headers = this.headers;
            results.baseUrl = new URL(`${this.client.getUri()}/listZoneZoneUsers`);
            results.httpMethod = HttpMethod.Put;
            results.body = _body;
    ...
    async list(results, organizationId) {
        ...
        return this.client.put('/listZones', {
            ..._body,
            pageNumber: results.pageNumber,
            pageSize: results.pageSize,
        })
            ...
            results.pageToken = response.headers.pagetoken ?? response.headers.pageToken;
            results.headers = this.headers;
            results.baseUrl = new URL(`${this.client.getUri()}/listZones`);
            results.httpMethod = HttpMethod.Put;
            results.body = _body;
