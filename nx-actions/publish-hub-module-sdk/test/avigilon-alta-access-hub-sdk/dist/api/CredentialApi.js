...
export class CredentialApiHubImpl {
    client;
    headers;
    ...
    async listCardFormats(results, organizationId) {
        ...
        return this.client.put('/listCardFormats', {
            ..._body,
    ...
    async listCredentialActionTypes(results, organizationId) {
        ...
        return this.client.put('/listCredentialActionTypes', {
            ..._body,
            pageNumber: results.pageNumber,
            pageSize: results.pageSize,
        })
    ...
    async listCredentialActions(results, organizationId, credentialId) {
        ...
        return this.client.put('/listCredentialActions', {
            ..._body,
            pageNumber: results.pageNumber,
            pageSize: results.pageSize,
        })
    ...
    async listCredentialTypes(results, organizationId) {
        ...
        return this.client.put('/listCredentialTypes', {
            ..._body,
            pageNumber: results.pageNumber,
            pageSize: results.pageSize,
        })
    ...
    async listOrgCredentials(results, organizationId) {
        ...
        return this.client.put('/listOrgCredentials', {
            ..._body,
            pageNumber: results.pageNumber,
            pageSize: results.pageSize,
        })
