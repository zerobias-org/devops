...
tar xvf zerobias-platform-content*.tgz

echo "### Applying schema ${CONTENT_PACKAGE} to database ${PGDATABASE}"
PGOPTIONS='--client-min-messages=warning'
echo "### Dropping DB if exists: $PGDATABASE"
${ROOTDIR}/node_modules/@zerobias-org/devops-tools/scripts/db/drop.sh

echo "### (Re-)Creating DB $PGDATABASE"
${ROOTDIR}/node_modules/@zerobias-org/devops-tools/scripts/db/create.sh
